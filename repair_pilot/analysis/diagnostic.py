...
def diagnostic(typ: str, start_date: str, end_date: str) -> pd.DataFrame:
    ...
    save_plotly_as_html(fig, Path.join(RESULTS_PATH, "reports", "component_dependencies", "figures"), typ, start_date, end_date)
    save_df_as_csv(rules, Path.join(RESULTS_PATH, "reports", "component_analysis"), f"component_rules_{typ}")
